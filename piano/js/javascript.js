const Q4 = new Audio ("../music/D5.mp3");
const A4 = new Audio ("../music/C4.mp3");
const Z4 = new Audio ("../music/C5.mp3");
const W4 = new Audio ("../music/A4.mp3");
const S4 = new Audio ("../music/B4.mp3");
const X4 = new Audio ("../music/D4.mp3");
const E4 = new Audio ("../music/E4.mp3");
const D4 = new Audio ("../music/E5.mp3");
const C4 = new Audio ("../music/F4.mp3");
const R4 = new Audio ("../music/G4.mp3");
const F4 = new Audio ("../music/Ab4.mp3");
const V4 = new Audio ("../music/Bb4.mp3");
const T4 = new Audio ("../music/Db4.mp3");
const G4 = new Audio ("../music/Db5.mp3");
const B4 = new Audio ("../music/Eb4.mp3");
const Y4 = new Audio ("../music/Eb5.mp3");
const H4 = new Audio ("../music/Gb4.mp3");
const N4 = new Audio ("../music/AA.mp3");
const U4 = new Audio ("../music/BBB.mp3");
const J4 = new Audio ("../music/CCC.mp3");
const M4 = new Audio ("../music/piano_C_sharp.mp3");
const I4 = new Audio ("../music/piano_D.mp3");
const K4 = new Audio ("../music/piano_D_sharp.mp3");
const O4 = new Audio ("../music/piano_E.mp3");
const L4 = new Audio ("../music/piano_F.mp3");
const P4 = new Audio ("../music/piano_F_sharp.mp3");
const Q1 = new Audio ("../music/piano_G.mp3");
const Q2 = new Audio ("../music/piano_middle_C.mp3");
const Q3 = new Audio ("../music/piano-Cs4-long.mp3");
const Q44 = new Audio ("../music/Sonar ping.wav");
const Q5 = new Audio ("../music/XylophoneGAR_7300-000.wav");
const Q6 = new Audio ("../music/68440__pinkyfinger__piano-c.wav");
const Q7 = new Audio ("../music/68439__pinkyfinger__piano-bb.wav");
const Q8 = new Audio ("../music/68440__pinkyfinger__piano-c.wav");
const Q9 = new Audio ("../music/68441__pinkyfinger__piano-c.wav");
const Q10 = new Audio ("../music/68442__pinkyfinger__piano-d.wav");
const Q11 = new Audio ("../music/68443__pinkyfinger__piano-e.wav");
const Q12 = new Audio ("../music/68444__pinkyfinger__piano-eb.wav");
const Q13 = new Audio ("../music/68445__pinkyfinger__piano-f.wav");
const Q14 = new Audio ("../music/68446__pinkyfinger__piano-f.wav");
const Q15 = new Audio ("../music/68447__pinkyfinger__piano-g.wav");
const Q16 = new Audio ("../music/68448__pinkyfinger__piano-g.wav");
const Q17 = new Audio ("../music/68440__pinkyfinger__piano-c.wav");
        ...
        window.addEventListener("keydown", ({keyCode})=> {
            ...
            if (keyCode === 65) return playA4();
            if (keyCode === 90) return playZ4();
            if (keyCode === 87) return playW4();
            if (keyCode === 83) return playS4();
            if (keyCode === 88) return playX4();
            if (keyCode === 69) return playE4();
            if (keyCode === 68) return playD4();
            if (keyCode === 67) return playC4();
            if (keyCode === 82) return playR4();
            if (keyCode === 70) return playF4();
            if (keyCode === 86) return playV4();
            if (keyCode === 84) return playT4();
            if (keyCode === 71) return playG4();
            if (keyCode === 66) return playB4();
            if (keyCode === 89) return playY4();
            if (keyCode === 72) return playH4();
            if (keyCode === 78) return playN4();
            if (keyCode === 85) return playU4();
            if (keyCode === 74) return playJ4();
            if (keyCode === 77) return playM4();
            if (keyCode === 73) return playI4();
            if (keyCode === 75) return playK4();
            if (keyCode === 79) return playO4();
            if (keyCode === 76) return playL4();
            if (keyCode === 80) return playP4();
            ...
            if (keyCode === 186) return playQ15();
            if (keyCode === 188) return playQ16();
